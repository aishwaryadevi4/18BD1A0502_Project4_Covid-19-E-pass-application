...
account_sid='AC5d42c330dc77a60fb589a7495e64baf1'
auth_token='0d7ab6d33b90e3a557057303c1f05c25'
...
def login_registration_dtls():
    ...
    if travel_pass<30 and request.method=='POST':
        status='CONFIRMED'
        client.messages.create(to="whatsapp:+917702696639",from_="whatsapp:+14155238886",
        ...
        client.messages.create(to="whatsapp:+917702696639",
